...
exports.onPushForIndex = function(req,res){
    ...
    analysis.getInfo(uid,function(info){
        ...
        if(today_energy[0] < 60){
            push_message.push("今日能量较低，请速速通过自助或友人相助，补充能量。");
        }
        else if(today_luck[0] < 60){
            push_message.push("今日运程较低，请速速通过自助或友人相助，补充能量。");
        }
        else if(today_energy[0] > 85){
            push_message.push("今日能量较高，可以为友送福。");
        }
        if(0 == push_message.length){
            analysis.getLuck2(uid,consts.TYPE_TIME.TYPE_TIME_TODAY,consts.TYPE_SCORE.TYPE_SCORE_LUCK,new Date(),function(answer){
